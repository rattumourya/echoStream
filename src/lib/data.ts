...
export const playlists: Playlist[] = [
    { id: '1', title: 'Chill Vibes', description: 'Relax and unwind with these laid-back tracks.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'coffee shop' },
    { id: '2', title: 'Focus Flow', description: 'Instrumental tracks to help you concentrate.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'library books' },
    { id: '3', title: 'Workout Hits', description: 'High-energy tracks to power your workout.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'gym weights' },
    { id: '4', title: 'Late Night Drive', description: 'Synthwave and electronic beats for the open road.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'night road' },
    { id: '5', title: 'Indie Discovery', description: 'Fresh tracks from emerging artists.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'guitar case' },
    { id: '6', title: 'Acoustic Morning', description: 'Gentle acoustic songs to start your day.', coverArt: 'https://placehold.co/600x600.png', 'data-ai-hint': 'morning coffee' },
];
...
export async function getPlaylists(): Promise<Playlist[]> {
    ...
    const playlistList = playlistSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() } as Playlist));
    return playlistList.length > 0 ? playlistList : playlists;
}
